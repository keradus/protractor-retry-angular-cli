...
var retryFileSuffix = "";
function setRetryFileSuffix(suffix) {
    console.log('FRS - setRetryFileSuffix', suffix);
    debug('setRetryFileSuffix', suffix);
    retryFileSuffix = suffix;
}
...
function resultsFilePath(retry) {
    ...
    if (retryFileSuffix) {
        fileName = fileName + '-' + retryFileSuffix;
    }
    if (retry) {
        fileName = fileName + '-' + retry;
    }
    console.log('FRS - resultsFile', resultsDir + '/' + fileName + '.xml');
...
module.exports = {
    setRetryFileSuffix: setRetryFileSuffix,
